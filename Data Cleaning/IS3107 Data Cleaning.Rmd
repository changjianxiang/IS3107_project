...
cp_master <- read.csv("carpark_master_data_18032023.csv", header = T)
cp_availability <- read.csv("carpark_availability_18032023.csv", header = T)
cp_rates <- read.csv("carpark_rates_18032023.csv", header = T)
```
...
# write.csv(cp_availability_new, "C:/Users/tongt/Downloads/IS3107/Project/carpark_availability.csv", row.names=FALSE)

# write.csv(cp_rates, "C:/Users/tongt/Downloads/IS3107/Project/carpark_rates.csv", row.names=FALSE)

#write.csv(cp_master, "C:/Users/tongt/Downloads/IS3107/Project/carpark_master.csv", row.names=FALSE)
```
